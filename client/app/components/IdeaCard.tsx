...
interface IdeaCardProps {
  ...
  const IdeaCard: React.FC<IdeaCardProps> = ({ username, title, description,speciality ,  upvotes, tags , profileImage }) => {
  return (
    <div className="flex max-tablet:flex-wrap border-t-[1px] border-gray-600 border-opacity-50  py-3 mt-5">
